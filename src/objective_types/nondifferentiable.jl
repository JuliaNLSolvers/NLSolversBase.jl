...
NonDifferentiable(f::OnceDifferentiable, x) = NonDifferentiable(f, x, f.F)
NonDifferentiable(f::TwiceDifferentiable, x) = NonDifferentiable(f, x, f.F)
NonDifferentiable(f::TwiceDifferentiableHV, x) = NonDifferentiable(f, x, f.F)
